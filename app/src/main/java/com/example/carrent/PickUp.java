...
public class PickUp extends AppCompatActivity implements OnMapReadyCallback, com.google.android.gms.location.LocationListener {
            ...
            public void onClick(View v) {
                ...
                collectionReference.add(user)
                        .addOnSuccessListener(documentReference -> {
                            ...
                            Intent intent = new Intent(PickUp.this, MainActivity.class);
